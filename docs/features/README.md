...
| Embed watermarks in generated audio | [Audio watermarking](audio_watermarking.md) | Includes streaming behavior and request failure policy |
...
integration boundaries. It is not yet a supported launch recipe.
