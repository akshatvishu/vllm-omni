...
""".strip()
    ...
    assert cfg.audio_tokenizer_config.enc_kwargs["backbone"]["attn_implementation"] == "sdpa"
    assert cfg.audio_tokenizer_config.dec_kwargs["backbone"]["_attn_implementation"] == "sdpa"
